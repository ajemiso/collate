    ...
    class Meta:
        ...
        widgets = {
            ...
            'loan_story': forms.Textarea(attrs={'class': 'form-control', 'placeholder': 'Loan Story',
                                                                                        'rows': 9}),
            'subject_property_address': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '1234 Main St.',
                                                               'id': 'address'}),
            'subject_property_city': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Beverly Hills',
                                                            'id': 'city'}),
            'subject_property_state': forms.Select(attrs={'class': 'form-control', 'id': 'state'}),
            'subject_property_zip': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '90210',
                                                           'id': 'zip'}),
            'appraisal_value': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '$',
                                                      'id': 'appraisal-value'}),
